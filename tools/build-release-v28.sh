...
BUILD_DIR="/mnt/c/Users/john.X86/Downloads/RKDevTool_Release_v2.86/RKDevTool_Release_v2.86/Output/Armbian/.build-v28"
source "$CONFIG"
TMPDIR="/mnt/c/Users/john.X86/Downloads/RKDevTool_Release_v2.86/RKDevTool_Release_v2.86/Output/Armbian/.wsl-tmp"
export TMPDIR
mkdir -p "$TMPDIR" "$BUILD_DIR"
echo "=== v28 release (rk3308-vop lut_size=256 + panel before DRM) ==="
