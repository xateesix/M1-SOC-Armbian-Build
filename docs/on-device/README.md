# On-device documentation (v0.64.1)

Companion firmware for the Artillery M1 Pro X1 S1-SOC (RK3308BS). Additional guides are in this folder.
...
WiFi is **not** pre-configured on the published image.
